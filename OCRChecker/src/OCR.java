...
public class OCR {
	...
	public static String extractInfo(BufferedImage bimg, Tesseract instance) throws JSONException, IOException{
	    ...
	    rectarr[0] = new Rectangle((int) (width * 0.31), (int) (height * 1.1 / 12), (int) (width * 0.22), (int) (height * 0.9 / 12));
	    rectarr[1] = new Rectangle((int) (width * 0.46), (int) (height * 0.1 / 24), (int) (width * 0.09), (int) (height * 0.9 / 12));
